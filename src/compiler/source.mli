...
(** [from_file path] is a new source loaded from a file at some given [path].
    This function raises a [Sys_error] exception if it fails to open the file at the specified
    [path]. *)
...
(** [at source offset] is the character at some [offset] in a [source], or [None] if the [offset] is
    out of bounds. *)
